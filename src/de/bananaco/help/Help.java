...
public class Help {
	...
	public static void load(JavaPlugin plugin) {
		...
		if(!helpFile.exists()) {
			...
			BufferedWriter br = new BufferedWriter(new OutputStreamWriter(new BufferedOutputStream(new FileOutputStream(helpFile))));
			br.write(help);
			br.close();
			System.out.println("[Help] Help file for "+name+" saved in "+helpFile.getName());
		}
		} catch (Exception e) {
			e.printStackTrace();
		}
