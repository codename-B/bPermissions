...
public class Permissions extends JavaPlugin {
    ...
    public void doInitialize(PluginLoader pluginLoader, Server server, PluginDescriptionFile pdf, File file1, File file2, ClassLoader classLoader) {
    ...
    public PermissionHandler getHandler() {
        if (Security == null) {
            Security = new com.ubempire.permissions.PermissionBridge();
        }
        return Security;
    }
}
